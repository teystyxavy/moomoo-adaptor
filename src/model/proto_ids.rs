//! Rust port of MMAPI_Define_ProtoID.h — the moomoo OpenD wire-protocol ID registry.
//! Not derivable from the .proto files or generated code; this mapping only exists
//! in moomoo's own SDK headers, transcribed here by hand.

// Reserved numeric ranges
pub const TRD_BEGIN: u32 = 2000;
pub const TRD_END: u32 = 2999;
pub const QOT_BEGIN: u32 = 3000;
pub const QOT_END: u32 = 3999;

// --- Session / Connection ---
pub const INIT_CONNECT: u32 = 1001;
pub const GET_GLOBAL_STATE: u32 = 1002;
pub const NOTIFY: u32 = 1003;
...
pub const TRD_UPDATE_ORDER: u32 = 2208;

pub const TRD_GET_ORDER_FILL_LIST: u32 = 2211;
pub const TRD_UPDATE_ORDER_FILL: u32 = 2218;
...
pub const QOT_UPDATE_BASIC_QOT: u32 = 3005;
pub const QOT_GET_KL: u32 = 3006;
pub const QOT_UPDATE_KL: u32 = 3007;
pub const QOT_GET_RT: u32 = 3008;
pub const QOT_UPDATE_RT: u32 = 3009;
pub const QOT_GET_TICKER: u32 = 3010;
pub const QOT_UPDATE_TICKER: u32 = 3011;
pub const QOT_GET_ORDER_BOOK: u32 = 3012;
pub const QOT_UPDATE_ORDER_BOOK: u32 = 3013;
pub const QOT_GET_BROKER: u32 = 3014;
pub const QOT_UPDATE_BROKER: u32 = 3015;

pub const QOT_UPDATE_PRICE_REMINDER: u32 = 3019;

// --- Quote: historical data ---
pub const QOT_GET_HISTORY_KL: u32 = 3100;
pub const QOT_GET_HISTORY_KL_POINTS: u32 = 3101;
pub const QOT_GET_REHAB: u32 = 3102;
...
// --- Quote: reference / discovery / fundamentals / options / rankings / macro ---
pub const QOT_GET_SUSPEND: u32 = 3201;
...
pub const QOT_PUSH_INDICATOR_CALC: u32 = 3261;
...
pub const QOT_UPDATE_OPTION_EVENT: u32 = 3310;
